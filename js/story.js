...
const QUEST_STAGES = [
    {
        ...
        storyText: "Доброе утро, дамы! Я - детектив Роза Шерлок. Сегодня, в этот прекрасный праздник, произошло ЧП: из офиса пропали все праздничные тюльпаны! Первая зацепка была обнаружена возле кофемашины - чашка с необычным рисунком на пенке. Помогите мне разгадать этот код!",
        game: "minesweeper",
        difficulty: "easy",
    ...
    },
    {
        ...
        storyText: "В холодильнике мы нашли коробку с нарисованным лабиринтом. К ней прикреплена записка: 'Последнее испытание приведет к разгадке тайны пропавших тюльпанов. Пройдите лабиринт и узнайте, где спрятан настоящий сюрприз!'",
        game: "pairs",
        difficulty: "hard",
