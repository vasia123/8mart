/**
 * Основной модуль приложения Детективной игры "Дело о пропавших тюльпанах"
...
class DetectiveGame {
    ...
    _showStartScreen() {
        ...
        mainContainer.innerHTML = `
            <div class="start-screen">
                <h1>Дело о пропавших тюльпанах</h1>
                <div class="detective-large">🕵️‍♀️</div>
                <p>Добро пожаловать в детективную игру!<br>Для начала расследования отсканируйте QR-код.</p>
    ...
    _loadStage(stage) {
        ...
        document.title = `Дело о пропавших тюльпанах`;
...
Вы блестяще прошли все испытания и разгадали тайну пропавших тюльпанов.
Оказалось, что тюльпаны были спрятаны, чтобы подготовить для вас особый сюрприз!
    ...
    _renderFinalScreen() {
        ...
        mainContainer.innerHTML = `
            <div class="final-message">
                ...
                <p>Вы блестяще прошли все испытания и разгадали тайну пропавших тюльпанов.</p>
                <p>Оказалось, что тюльпаны были спрятаны, чтобы подготовить для вас особый сюрприз!</p>
